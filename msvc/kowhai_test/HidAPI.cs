...
{
    // HidAPI from https://github.com/djpnewton/hidapi
    public class HidAPI
    {
#if LINUX
        ...
        {
            IntPtr phid_device_info = hid_enumerate(0, 0);
            PrintEnumeration(phid_device_info);
            hid_free_enumeration(phid_device_info);
        }
