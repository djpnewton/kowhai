 ...
 * @param left_node_index, The index of the left node in the original tree descriptor
 ...
 * @param righ_node_index, The index of the right node in the original tree descriptor
 ...
 */
typedef int (*kowhai_on_diff_t)(const struct kowhai_node_t *left_node, int left_node_index, void *left_data, int left_offset, const struct kowhai_node_t *right_node, int right_node_index, void *right_data, int right_offset, int index, int depth);
